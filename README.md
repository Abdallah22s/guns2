...
version 2.0 - Enhanced with Advanced Video Processing

## Glossary
WDE - Weapon Detection Event
WEPAPP - Toolkit that uses trained AI models to report the existence of WDEs when detected via streaming devices, e.g., cameras
...
- **Full Arabic Translation**: Complete RTL/LTR support with Arabic interface
- **Language Toggle**: Switch between English and Arabic with one click
- **RTL Layout**: Proper right-to-left layout for Arabic users

### 🎥 Advanced Video Processing
- **Video Upload**: Upload video files directly from your computer
- **Intelligent Scanning**: Configurable scan intervals (5-10 seconds) for optimal detection
- **GPU/CPU Selection**: Choose between GPU acceleration or CPU processing
- **Progress Tracking**: Real-time progress bar during video processing
- **Batch Processing**: Process multiple videos simultaneously

### 🖼️ Enhanced Detection Display
- **Modal Gallery**: Floating window to display all detected weapon images
- **Smart Thumbnails**: Organized display of detection results
- **Detection Statistics**: Comprehensive view of detection confidence and timing
- **Export Results**: Download detection summaries and images

### 🎯 Improved User Interface
- **Modern Design**: Enhanced UI with better visual hierarchy
- **Responsive Layout**: Optimized for desktop and mobile devices
- **Quick Actions**: Direct access to video processing from camera list
...
- Cameras with enhanced video processing capabilities
- Weapon Detection Events with improved visualization
