...
def weprunner():
    ...
    payload[cons.VIDEO_LINK] = cfg.source.get(
        cons.VIDEO_LINK
    )  #'/Users/reed/Stuff/ereed/customers/iterate/wep/redo/wepcache/AR_15.mp4'
    ...
    payload[cons.FILE_ORIGINAL_NAME] = cfg.source.get(
        cons.FILE_NAME
    )  #'9mm_fast_walk.mp4'
